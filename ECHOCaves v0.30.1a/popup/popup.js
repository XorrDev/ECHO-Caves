...
function Confirm() {
    ...
    if(json !== "") {
        ...
        document.getElementById("Revert").style = "background-color:#5A6E92;color:#FFFFFF;";
            ...
            document.getElementById("errTheme").innerHTML = "[err: 2] Theme cannot be parsed. Try again.";
        }
    }
}
...
function Revert() {
    chrome.storage.local.clear(function() {
        ...
        if (error) {
            document.getElementById("errTheme").innerHTML = "[err: 1] Problem loading default data.";
        }else {
            document.getElementById("Revert").disabled = true;
            document.getElementById("Revert").style = "background-color:#333F54;color:#B3B3B3;";
            document.getElementById("errTheme").style = "color:#5aff47;";
            document.getElementById("errTheme").innerHTML = "Default theme loaded! Refresh the page.";
        }
    });
}
